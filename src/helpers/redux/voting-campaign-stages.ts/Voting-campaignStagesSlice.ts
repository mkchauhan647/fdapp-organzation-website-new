...
const initialState: any = {
  ...
  voting_stage_candidate_by_id_data: {},
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(GetCandidatesByVotingStages.fulfilled, (state, action) => {
        ...
        //send response
        state.candidates_by_voting_stages_data.fulfilledResponse =
          action.payload;
      })
      ...
      .addCase(GetVotingStagesByVotingCampaignID.fulfilled, (state, action) => {
        ...
        //send response
        state.voting_stages_by_campaign_id_data.fulfilledResponse =
          action.payload;
      })
      ...
      // Voting stage candidate by ID
      .addCase(GetVotingStageCandidateById.pending, (state) => {
        state.voting_stage_candidate_by_id_data.isPending = true;
        state.voting_stage_candidate_by_id_data.isFulfilled = false;
        state.voting_stage_candidate_by_id_data.isRejected = false;
      })
      .addCase(GetVotingStageCandidateById.fulfilled, (state, action) => {
        state.voting_stage_candidate_by_id_data.isPending = false;
        state.voting_stage_candidate_by_id_data.isFulfilled = true;
        state.voting_stage_candidate_by_id_data.isRejected = false;
        state.voting_stage_candidate_by_id_data.fulfilledResponse =
          action.payload;
      })
      .addCase(GetVotingStageCandidateById.rejected, (state, action) => {
        state.voting_stage_candidate_by_id_data.isPending = false;
        state.voting_stage_candidate_by_id_data.isFulfilled = false;
        state.voting_stage_candidate_by_id_data.isRejected = true;
        state.voting_stage_candidate_by_id_data.errorResponse = action.payload;
      });
  },
});
