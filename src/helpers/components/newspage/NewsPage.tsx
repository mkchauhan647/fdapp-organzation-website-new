    ...
    <>
      <div className="w-full pt-10 bg-[var(--pagebg)] pb-[70px] ">
        <div className="container mx-auto flex flex-col gap-8 justify-center">
          <div>
            <h1 className="text-[var(--blue)] text-3xl font-secular">
              News & Updates
            </h1>
          </div>
          ...
          <div className="flex md:flex-row  md:justify-between md:px-0 flex-col px-3">
              ...
              {FilteredNews &&
                FilteredNews.map((news: News, index: number) => {
                  return (
                    <div
                      key={index}
                      className="flex flex-col gap-[2rem] border-b-2 py-[3rem]"
                    >
                      ...
                      <p
                        className="text-[var(--blue)] font-ubuntu text-justify"
            ...
            <div className="w-full md:w-[35%]  mt-[3rem] flex flex-col gap-[1rem]">
              {AllNews &&
                AllNews.map((news: News, index: number) => {
                  return (
                    <li
                      key={index}
                      className="list-none px-4 py-4 bg-white shadow-sm"
                    >
                      <Link href={`/newspage?id=${news.id}`}>
                        <h2 className="text-[var(--blue)] font-ubuntu text-justify">
                          {" "}
                          {news.title}
                        </h2>
                      </Link>
