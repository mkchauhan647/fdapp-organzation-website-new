                                        ...
                                        <div className='px-[.5rem] py-[.5rem] shadow-md hover:shadow-lg transition-ease duration-300 rounded-md'>
                                            <Link href={`/newspage?id=${news.id}`} key={index} className='flex flex-col h-full gap-[1rem]'>
                                                <div className='w-full h-[15rem]'>
                                                    <Image src={process.env.NEXT_PUBLIC_AWS_URI + news.image} alt={news.title} height={500} 
                                                    width={900} className='h-full w-full object-cover' />
                                                </div>
                                                ...
                                                <div className='flex flex-col gap-3'>
                                                    <div className='flex items-center'>
                                                        ...
                                                        <span className='flex h-fit'>
                                                            <span className='px-[5px]'><p className='paragraph text-[var(--blue)]'>FDAPP</p></span>
