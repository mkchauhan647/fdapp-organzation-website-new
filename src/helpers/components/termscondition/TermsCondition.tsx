                ...
                <div className='container mx-auto flex flex-col gap-8 justify-center'>
                    ...
                    <div className='flex flex-col gap-5'>
                        ...
                        < div>
                            ...
                            <p className='text-[var(--blue)]'>If you have any questions or concerns regarding these Terms and Conditions, please contact us at <Link href="mailto:contact@fdapp.co.uk" className='text-[blue] underline'>contact@fdapp.co.uk</Link> </p>
                        </div>
